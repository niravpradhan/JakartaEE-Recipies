...
@WebServlet(name = "MultiplyServlet", urlPatterns = {"/chapter01/MultiplyServlet"})
public class MultiplyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int product = Integer.valueOf(numA) * Integer.valueOf(numB);
        try {
            /*
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>The Product of the Numbers</title>");
            out.println("</head>");
            out.println("<body>");
