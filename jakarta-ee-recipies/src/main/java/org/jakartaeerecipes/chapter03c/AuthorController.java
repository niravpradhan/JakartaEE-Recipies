...
public class AuthorController implements Serializable {
    ...
    private void populateAuthors() {
        ...
        Book book2 = new Book("Java EE 8 Recipes", "javaee8recipes.png");
     ...
     * only those authors who were involved with the Java 7 Recipes book
     *
     * @return
     */
    public String populateJavaRecipesAuthorList() {
        ...
        for (Author author : authorBookList) {
            ...
            for (Book book : books) {
                if (book.getTitle().equals("Java 9 Recipes")) {
    ...
    /**
     * Searches through all Author objects and populates the authorList with
     * only those authors who were involved with the Java EE 7 Recipes book
     *
     * @return
     */
    public String populateJavaEERecipesAuthorList() {
        ...
        for (Author author : authorBookList) {
            List<Book> books = author.getBooks();
            for (Book book : books) {
                if (book.getTitle().equals("Java EE 8 Recipes")) {
                    // Set the currently selected book
                    setCurrentBook(book);
                    authorList.add(author);
                }
    ...
    public void findAuthor() {
        System.out.println("finding: " + authorLast);
     ...
     * @return
     */
    public List complete(String text) {
